...
fn float16_benches(c: &mut Criterion) {
    ...
    let mandatory_f16_leaf_desc = schema.column(19);
    let optional_f16_leaf_desc = schema.column(20);
...
fn add_benches(c: &mut Criterion) {
    ...
    let int32_list_desc = schema.column(15);
    let fixed32_list_desc = schema.column(16);
    let mandatory_binary_column_desc = schema.column(17);
    let optional_binary_column_desc = schema.column(18);
    let mandatory_uint8_column_desc = schema.column(29);
    let optional_uint8_column_desc = schema.column(30);
    let mandatory_uint16_column_desc = schema.column(31);
    let optional_uint16_column_desc = schema.column(32);
    let mandatory_uint32_column_desc = schema.column(33);
    let optional_uint32_column_desc = schema.column(34);
    let mandatory_int8_column_desc = schema.column(35);
    let optional_int8_column_desc = schema.column(36);
    let mandatory_int16_column_desc = schema.column(37);
    let optional_int16_column_desc = schema.column(38);
    let mandatory_uint64_column_desc = schema.column(39);
    let optional_uint64_column_desc = schema.column(40);
    let mandatory_struct_optional_in32_column_desc = schema.column(41);
    let optional_struct_optional_in32_column_desc = schema.column(42);
    ...
    let mandatory_flba2_leaf_desc = schema.column(21);
    let optional_flba2_leaf_desc = schema.column(22);
    ...
    let mandatory_flba4_leaf_desc = schema.column(23);
    let optional_flba4_leaf_desc = schema.column(24);
    ...
    let mandatory_flba8_leaf_desc = schema.column(25);
    let optional_flba8_leaf_desc = schema.column(26);
    ...
    let mandatory_flba16_leaf_desc = schema.column(27);
    let optional_flba16_leaf_desc = schema.column(28);
