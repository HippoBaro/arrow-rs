...
impl ValueSelection {
    ...
    fn extend_sparse_indices<I>(&mut self, iter: I)
    where
...
impl ArrayLevels {
    ...
    fn extend_sparse_value_indices<I>(&mut self, iter: I)
    where
        I: IntoIterator<Item = usize>,
    {
        self.values.extend_sparse_indices(iter);
    }
